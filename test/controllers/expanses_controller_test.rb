...
class ExpansesControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create expanse' do
    assert_difference('Expanse.count') do
      post expanses_url, params: { expanse: { amount: @expanse.amount, name: @expanse.name } }
    end
  ...
  test 'should update expanse' do
    patch expanse_url(@expanse), params: { expanse: { amount: @expanse.amount, name: @expanse.name } }
